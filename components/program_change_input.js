export default function ProgramChangeInput(props) {
  let programNumberChange = (e) => {
    ...
    props
      .deviceOutput()
      .setProgram(intProgramNumber, { channels: intMidiChannel });
    console.log("Command sent", {
      intProgramNumber: intProgramNumber,
      channels: intMidiChannel,
    });
  };
  ...
  return (
    <div className={props.className}>
      ...
      <input
        ...
        type="number"
        value={props.programNumber}
        min="0"
        max="127"
        onChange={programNumberChange}
      />
    </div>
  );
}
